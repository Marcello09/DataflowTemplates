 ...
 */
@Template(
    name = "MongoDB_to_BigQuery_Replace",
    category = TemplateCategory.BATCH,
    displayName = "MongoDB to BigQuery (Replace Table)",
    description =
        "The MongoDB to BigQuery template is a batch pipeline that reads documents from MongoDB and writes them to "
            + "BigQuery by replacing the table and as specified by the <code>userOption</code> parameter.",
